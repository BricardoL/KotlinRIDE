...
class RequestDriverActivity : AppCompatActivity() {
    ...
    private lateinit var mExtraOrigin: String;
    private  lateinit var mExtraDestination: String;
    ...
    private fun cancelRequest() {
        mClientBookingProvider!!.delete(mAuthProvider!!.id).addOnSuccessListener { sendNotificationCancel() }
                        ...
                        override fun onResponse(call: Call<FCMResponse?>, response: Response<FCMResponse?>) {
                            if (response.body() != null) {
                                if (response.body()!!.success == 1) {
                                    Toast.makeText(this@RequestDriverActivity, "La solicitud se cancelo correctamente", Toast.LENGTH_SHORT).show()
