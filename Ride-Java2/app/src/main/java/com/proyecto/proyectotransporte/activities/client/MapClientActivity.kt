        ...
        private get() {
            mGeofireProvider!!.getActiveDrivers(mCurrentLatLng!!, 10.0).addGeoQueryEventListener(object : GeoQueryEventListener {
                override fun onKeyEntered(key: String, location: GeoLocation) {
                    ...
                    val marker = mMap!!.addMarker(MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.driver_icon)))
                    marker.tag = key
