    ...
    fun register(name: String?, email: String?, password: String?) {
        mAuthProvider!!.register(email, password).addOnCompleteListener { task ->
            ...
            if (task.isSuccessful) {
                ...
                Toast.makeText(this@RegisterActivity, "No se pudo registrar el usuario", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    fun create(client: Client?) {
        mClientProvider!!.create(client!!).addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                val intent = Intent(this@RegisterActivity, MapClientActivity::class.java)
